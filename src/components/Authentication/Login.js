...
const Login = (props) => {
  ...
  const handleClick = async (e) => {
    e.preventDefault();
    const response = await fetch('https://screenly-qpdq.onrender.com/api/auth/login', {
      method: 'POST',
      headers: {
...
const StyledWrapper = styled.div`
  ...
  align-items: center;
  height: auto; /* Changed from min-height: 80vh */
  padding: 2rem 1rem; /* Add padding to ensure content isn't too close to edges */
