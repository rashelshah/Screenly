...
const Login = (props) => {
  ...
  return (
    <>
    <h2 style={{color:"white", textAlign:"center", background:"  background: linear-gradient(135deg, #1a1a1a, #0d0d0d, #000000)"}}>Login to your Account</h2>
    <StyledWrapper>
...
const StyledWrapper = styled.div`
  ...
  align-items: center;
  min-height: 80vh; /* Ensure the wrapper takes the full viewport height */
  ...
  .inputForm {
    border: 1.5px solid #333; /* Dark border for input fields */
    border-radius: 10px;
    height: 50px;
    display: flex;
    align-items: center;
  ...
  .inputForm:focus-within {
    border: 1.5px solid #2d79f3; /* Highlight border on focus */
  }

  .button-submit {
    margin: 20px 0 10px 0;
    background-color: #2d79f3; /* Blue button */
    border: none;
    color: white;
    font-size: 15px;
    font-weight: 500;
  ...
  .span {
    color: #2d79f3; /* Blue text for links */
    cursor: pointer;
  }
  ...
  .btn:hover {
    border: 1px solid #2d79f3; /* Highlight border on hover */
  }
`;
